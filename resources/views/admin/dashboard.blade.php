@extends('admin.layout.dashboard_base')
@section('content')
                    ...
                    <div class="d-flex align-items-end row">
                        ...
                        <div class="col-5 text-center text-sm-left">
                            <div class="card-body pb-0 px-0 px-md-4">
                                <img
                                    src="{{ asset('dashboard/img/illustrations/card-advance-sale.png') }}"
                                    height="140"
                                    alt="view sales" />
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            <li class="d-flex mb-6">
                                <div class="me-4">
                                    <img src="{{ asset('dashboard/img/products/iphone.png') }}" alt="User" class="rounded" width="46" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex mb-6">
                                <div class="me-4">
                                    <img
                                        src="{{ asset('dashboard/img/products/nike-air-jordan.png') }}"
                                        alt="User"
                                        class="rounded"
                                        width="46" />
                                </div>
                            ...
                            <li class="d-flex mb-6">
                                <div class="me-4">
                                    <img src="{{ asset('dashboard/img/products/headphones.png') }}" alt="User" class="rounded" width="46" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex mb-6">
                                <div class="me-4">
                                    <img
                                        src="{{ asset('dashboard/img/products/apple-watch.png') }}"
                                        alt="User"
                                        class="rounded"
                                        width="46" />
                                </div>
                            ...
                            <li class="d-flex mb-6">
                                <div class="me-4">
                                    <img
                                        src="{{ asset('dashboard/img/products/amazon-echo.png') }}"
                                        alt="User"
                                        class="rounded"
                                        width="46" />
                                </div>
                            ...
                            <li class="d-flex">
                                <div class="me-4">
                                    <img
                                        src="{{ asset('dashboard/img/products/play-station.png') }}"
                                        alt="User"
                                        class="rounded"
                                        width="46" />
                                </div>
