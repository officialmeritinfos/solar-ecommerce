...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="newPost" method="post" action="{{ route('admin.product.edit.process',$product->id) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea
                                        ...
                                        aria-label="Post title">{{ $product->short_description }}</textarea>
                                </div>
                                <!-- Description -->
                                <div class="mb-6">
                                                ...
                                                <div class="row mb-4 g-4 pe-md-4">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-check ms-2 mt-2 mb-4">
                                                            <input class="form-check-input" type="checkbox" value="1" id="price-charge-tax"
                                                                   {{ ($product->track_inventory)?'checked':'' }} name="trackInventory" />
                                                        ...
                                                        <div class="input-group">
                                                            <select name="dimension" class="form-select" required>
                                                                ...
                                                                @foreach (\App\Enums\Dimension::cases() as $dimension)
                                                                    <option value="{{ $dimension->value }}" {{ ($product->dimension==$dimension->value)?'selected':'' }}>
                        ...
                        <div class="card mb-6">
                            ...
                            <div class="card-body">
                                ...
                                <div id="imagePreviewContainer" class="text-center mt-3" >
                                    <img id="imagePreview" src="{{ asset($product->featuredImage) }}" alt=""
