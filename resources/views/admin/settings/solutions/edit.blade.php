...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="newPost" method="post" action="{{ route('admin.settings.solutions.edit.process',$solution->id) }}"
            ...
            <div class="app-ecommerce">
                ...
                <div
                    ...
                    <div class="d-flex align-content-center flex-wrap gap-4">
                        ...
                        <button type="submit" class="btn btn-primary submit">Update Solution</button>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="mb-6">
                                    ...
                                    <input
                                        ...
                                        placeholder=" title"
                                        name="title" value="{{ $solution->title }}"
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea
                                        ...
                                        name="contents"
                                        aria-label="Post title">{!! $solution->contents !!}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- /Product Information -->
