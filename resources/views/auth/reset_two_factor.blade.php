        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-start mb-6">
                    <strong>Warning:</strong> Only do this if you lost access to your authenticator but need immediate
                    access to your account. With this disabled, your account could be vulnerable to Brute-force.
                </p>
                <form id="twoStepsForm" action="{{ route('2fa.reset.process') }}" method="POST">
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        <label for="email" class="form-label">Recovery Code</label>
                        <textarea
                            type="text"
                            class="form-control"
                            id="email"
                    ...
                    <button class="btn btn-primary d-grid w-100 mb-6 submit">Reset Account</button>
