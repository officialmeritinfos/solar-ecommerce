...
<div class="container">
    ...
    <p class="message">We've sent a password reset link to your registered email address. Please check your inbox and follow the instructions to reset your password.</p>
    <button id="resend-btn" class="btn btn-primary btn-resend">Resend Reset Link</button>
    <p id="countdown-text" class="countdown">You can request a new link in <span id="countdown">60</span> seconds.</p>
    <p class="text-muted mt-3">If you haven’t received the email, click the button above to resend it.</p>
</div>
...
<script>
    $(document).ready(function() {
        ...
        function startCountdown() {
            ...
            countdownInterval = setInterval(function() {
                ...
                if (countdown <= 0) {
                    ...
                    $("#countdown-text").hide();
                    $("#resend-btn").prop("disabled", false).text("Resend Reset Link");
                }
            }, 1000);
        }
        ...
        $("#resend-btn").click(function() {
            ...
            $.ajax({
                url: "{{ route('account-recovery.resend') }}",
                method: "POST",
