...
(function($) {
  ...
  THEMEMASCOT.isLTR = {
	...
	//Services-carousel
	if ($('.home3-testimonials-slider').length) {
		$('.home3-testimonials-slider').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 30,
			nav: true,
			...
			autoplay: true,
			autoplayTimeout: 10000,
			navText: ['<span class="fas fa-arrow-left-long"></span>', '<span class="fas fa-arrow-right-long"></span>'],
			responsive: {
				0: {
					items: 1
				},
	...
	// Three Items Carousel
	if ($('.home6-work-carousel').length) {
		$('.home6-work-carousel').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			autoplay:true,
			loop: true,
			margin: 20,
	...
	if ($('.home6-testimonial-carousel').length) {
		$('.home6-testimonial-carousel').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			animateOut: 'fadeOut',
			animateIn: 'fadeIn',
			dots: true,
